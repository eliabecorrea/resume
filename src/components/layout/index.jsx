...
const navigation = [
  ...
  { name: 'Formação acadêmica', href: '#' },
  { name: 'Experiência', href: '#' },
  { name: 'Informações adicionais', href: '#' },
]
const features = [
  {
    name: 'Push to deploy',
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center font-medium text-white" title='Eliabe Correa'>EC</div>
            </a>
          </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  <div className='w-40 h-40 bg-green-500 rounded-full flex items-center justify-center text-2xl text-white font-medium mx-auto'>EC</div>
                </h1>
